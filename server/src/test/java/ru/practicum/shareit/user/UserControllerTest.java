...
public class UserControllerTest {
    ...
    @Test
    public void testAddUserNameIsNull() throws Exception {
        UserCreationRequestDto dto = new UserCreationRequestDto();
        dto.setName(null);
        dto.setEmail("mail@mail.ru");
    ...
    @Test
    public void testAddUserEmailIsNull() throws Exception {
        UserCreationRequestDto dto = UserCreationRequestDto.builder().name("name").email(null).build();
